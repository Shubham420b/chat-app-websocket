...
$sendLocationButton.addEventListener('click', () => {
    ...
    $sendLocationButton.setAttribute('disabled', 'disabled')          // disabling the send location button
    ...
    navigator.geolocation.getCurrentPosition((position) => {
        socket.emit('sendLocation', {
            ...
            $sendLocationButton.removeAttribute('disabled')           // enabling the send location button
